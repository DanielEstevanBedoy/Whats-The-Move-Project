...
//                         <Link to="/CalendarPage" className="text-gray-700 hover:text-blue-500 transition duration-150">Calendar</Link>
//                         <Link to="/Friends" className="text-gray-700 hover:text-blue-500 transition duration-150">Friends</Link>
//                         <Link to="/Events" className="text-gray-700 hover:text-blue-500 transition duration-150">Events</Link>
//                     </div>
//                     <div className="flex items-center space-x-4">
//                         <button onClick={()=> auth.signOut()} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 transition duration-150">Sign out</button>
